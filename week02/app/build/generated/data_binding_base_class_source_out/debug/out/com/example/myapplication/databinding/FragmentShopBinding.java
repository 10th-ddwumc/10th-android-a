...
public final class FragmentShopBinding implements ViewBinding {
  ...
  private FragmentShopBinding(@NonNull FrameLayout rootView, @NonNull FrameLayout shopFragment) {
  ...
  public static FragmentShopBinding bind(@NonNull View rootView) {
    ...
    FrameLayout shopFragment = (FrameLayout) rootView;

    return new FragmentShopBinding((FrameLayout) rootView, shopFragment);
  }
}
