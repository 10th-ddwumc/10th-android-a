...
public final class FragmentCartBinding implements ViewBinding {
  ...
  @NonNull
  public final ConstraintLayout cartFragment;
  ...
  private FragmentCartBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnOrder,
      @NonNull ConstraintLayout cartFragment, @NonNull ImageView ivEmptyCart,
      @NonNull TextView tvEmptyCart) {
  ...
  public static FragmentCartBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      ConstraintLayout cartFragment = (ConstraintLayout) rootView;
      ...
      return new FragmentCartBinding((ConstraintLayout) rootView, btnOrder, cartFragment,
          ivEmptyCart, tvEmptyCart);
    }
